 ...
 */
package vn.fintechviet.mobileplatforms.application.management.ui.lookup.register.adapters;
...
import vn.fintechviet.mobileplatforms.application.management.utils.ProgressViewHolder;
...
public class LookupRegisterViewerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<LookupRegister> itemList;
     ...
     */
    public LookupRegisterViewerAdapter(Context context,
     ...
     * @param objects
     */
    public void setData(List<LookupRegister> objects) {
        this.itemList.clear();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_lookup_register_recycler_view, parent, false);
            LookupRegisterViewerViewHolder viewHolder = new LookupRegisterViewerViewHolder(view, recyclerViewOnItemClickListener);
            return viewHolder;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof LookupRegisterViewerViewHolder) {
            final LookupRegisterViewerViewHolder conversationViewHolder
     ...
     * @return
     */
    public List<LookupRegister> getItemList() {
        return itemList;
    }
}
