 ...
 */
@Module
public class MessagesDetailActivityModule {

    @Provides
    MessagesDetailViewModel provideMessagesDetailViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
        return new MessagesDetailViewModel(dataManager, schedulerProvider);
    }
}
