...
public class MessagesFragmentModule {
    ...
    @Provides
    MessagesViewModel provideMessagesViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
        return new MessagesViewModel(dataManager, schedulerProvider);
    }

    @Provides
    LinearLayoutManager provideLinearLayoutManager(MessagesFragment fragment) {
