...
public class Constants {
    ...
    public static final String FCM_TOKEN_REFRESHED_BROADCAST_ACTION = "vn.fintechviet.mobileplatforms.application.management.FCM_TOKEN_REFRESHED";
	...
	public static final String ACTION_RESPONSE = "vn.fintechviet.mobileplatforms.application.management.MESSAGE_PROCESSED";
