...
package vn.fintechviet.mobileplatforms.application.management.di.module;
...
import vn.fintechviet.mobileplatforms.application.management.data.AppDataManager;
import vn.fintechviet.mobileplatforms.application.management.data.DataManager;
import vn.fintechviet.mobileplatforms.application.management.data.local.db.AppDatabase;
import vn.fintechviet.mobileplatforms.application.management.data.local.db.AppDbHelper;
import vn.fintechviet.mobileplatforms.application.management.data.local.db.DbHelper;
import vn.fintechviet.mobileplatforms.application.management.data.local.prefs.AppPreferencesHelper;
import vn.fintechviet.mobileplatforms.application.management.data.local.prefs.PreferencesHelper;
import vn.fintechviet.mobileplatforms.application.management.data.remote.ApiHeader;
import vn.fintechviet.mobileplatforms.application.management.data.remote.ApiHelper;
import vn.fintechviet.mobileplatforms.application.management.data.remote.VietnamStateTreasuryService;
import vn.fintechviet.mobileplatforms.application.management.di.ApiInfo;
import vn.fintechviet.mobileplatforms.application.management.di.DatabaseInfo;
import vn.fintechviet.mobileplatforms.application.management.di.PreferenceInfo;
...
import vn.fintechviet.mobileplatforms.application.management.utils.rx.AppSchedulerProvider;
