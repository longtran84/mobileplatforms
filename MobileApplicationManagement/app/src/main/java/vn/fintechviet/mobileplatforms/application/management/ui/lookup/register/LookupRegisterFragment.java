...
import vn.fintechviet.mobileplatforms.application.management.databinding.FragmentLookupRegisterBinding;
import vn.fintechviet.mobileplatforms.application.management.ui.base.BaseFragment;
import vn.fintechviet.mobileplatforms.application.management.ui.lookup.register.adapters.LookupRegisterViewerAdapter;
...
//        }
    ...
    private void subscribeToLiveData() {
        lookupRegisterViewModel.getMutableLiveDataListLookupRegister().observe(this, x -> {
            Collections.sort(x, new Comparator<LookupRegister>() {
                public int compare(LookupRegister o1, LookupRegister o2) {
                    Date date1 = JDateFormat.fromString(o1.getRegistrationDate());
                    Date date2 = JDateFormat.fromString(o2.getRegistrationDate());
                    return date2.compareTo(date1);
                }
            });
            lookupRegisterViewerAdapter.setData(x);
        });
    }
