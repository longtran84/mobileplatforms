...
import vn.fintechviet.mobileplatforms.data.model.api.OrganizationRelatedBudgetResponse;
...
public interface VietnamStateTreasuryService {
    ...
    @Headers({"Content-Type: application/json", "apiCode: MOBILE_USER_NOTIFICATION_LIST_GET"})
    @GET("ftv-gateway/api")
