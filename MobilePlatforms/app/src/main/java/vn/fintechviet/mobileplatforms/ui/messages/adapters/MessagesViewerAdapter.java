...
public class MessagesViewerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            MessagesViewerViewHolder viewHolder = new MessagesViewerViewHolder(view, recyclerViewOnItemClickListener);
            return viewHolder;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MessagesViewerViewHolder) {
            ...
            if (null != articlesItem) {
                ...
                if (!StringUtils.isBlank(articlesItem.getContent())) {
                    conversationViewHolder.textViewPublishData.setText(articlesItem.getContent().trim());
                } else {
